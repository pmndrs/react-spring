...
meta:
  ...
  'og:url': https://beta.react-spring.dev/docs/advanced/controller
  'twitter:url': https://beta.react-spring.dev/docs/advanced/controller
sidebar_position: 3
---

# Controller

Manages [`SpringValue`s](/docs/advanced/spring-value) for our spring hooks. Can be used
in any framework, we recommend in react hooks!
