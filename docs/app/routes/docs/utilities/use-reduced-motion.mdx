...
meta:
  ...
  description: API documentaion for the useReducedMotion utility hook in React Spring.
  'og:description': API documentaion for the useReducedMotion utility hook in React Spring.
  'twitter:description': API documentaion for the useReducedMotion utility hook in React Spring.
  'og:url': https://beta.react-spring.dev/docs/utilities/use-is-mounted
  'twitter:url': https://beta.react-spring.dev/docs/utilities/use-is-mounted
sidebar_position: 2
---
...
However, you may need to directly know the preference to syncronize a third-party system e.g.
autoplaying a video.
...
these global objects are used for to syncronize hooks across your application. One property that can
