...
meta:
  ...
  description: API documentaion for the useTrail hook in React Spring.
  'og:description': API documentaion for the useTrail hook in React Spring.
  'twitter:description': API documentaion for the useTrail hook in React Spring.
  'og:url': https://beta.react-spring.dev/docs/components/use-trail
  'twitter:url': https://beta.react-spring.dev/docs/components/use-trail
sidebar_position: 5
---
