...
meta:
  ...
  description: API documentaion for the useTransition hook in React Spring.
  'og:description': API documentaion for the useTransition hook in React Spring.
  'twitter:description': API documentaion for the useTransition hook in React Spring.
  'og:url': https://beta.react-spring.dev/docs/components/use-transition
  'twitter:url': https://beta.react-spring.dev/docs/components/use-transition
sidebar_position: 3
---
