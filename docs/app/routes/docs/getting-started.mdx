...
meta:
  ...
  'og:url': https://beta.react-spring.dev/docs/getting-started
  'twitter:url': https://beta.react-spring.dev/docs/getting-started
sidebar_position: 2
---
...
And here's how to install it with [npm](https://www.npmjs.com/):

```jsx copy="npm install @react-spring/web"
