...
import ImageFadeDemo from '@react-spring/demo/src/sandboxes/image-fade/src/App'
import ListReorderingDemo from '@react-spring/demo/src/sandboxes/list-reordering/src/App'
import MasonryDemo from '@react-spring/demo/src/sandboxes/masonry/src/App'
import MultistageTransitionDemo from '@react-spring/demo/src/sandboxes/multistage-transition/src/App'
import NotificationHubDemo from '@react-spring/demo/src/sandboxes/notification-hub/src/App'
import SimpleTransitionDemo from '@react-spring/demo/src/sandboxes/simple-transition/src/App'
import ExitBeforeEnterDemo from '@react-spring/demo/src/sandboxes/exit-before-enter/src/App'
      ...
      {transitions(({ opacity }, item) => (
        <animated.div
          style={{
            ...
            display: opacity.to(o => (o < 0.1 ? 'none' : 'block')),
          }}>
          {item.fig}
        </animated.div>
      ))}
