...
The following script *bodies* embed `yarn` and MUST be rewritten:
...
- Script *names* MUST NOT change. Only their *bodies* change. Contributors with muscle memory keep working.
