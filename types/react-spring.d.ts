declare module 'react-spring' {
  ...
  export class Spring<DS extends object> extends PureComponent<
    SpringProps<DS>
  > {}
  ...
  export const animated: {
    <T extends ReactType>(comp: T): ForwardRefExoticComponent<
  ...
  > extends PureComponent<KeyframesProps<DS> & S> {
    ...
    static Transition<S extends object, DS extends object>(
      ...
      | S
      | Pick<TransitionProps<S, DS>, Exclude<keyof TransitionProps<DS>, 'to'>>,
      DS
    >
  }
}
